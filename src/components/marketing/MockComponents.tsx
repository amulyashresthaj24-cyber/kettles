  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-1.5 pl-[17px]">
        <span className="inline-flex items-center gap-1.5 rounded-md bg-[var(--k-bg2)] px-1.5 py-0.5 text-[10px] font-medium text-[var(--k-muted)] border border-[var(--k-line2)]">
    ...
    >
      {(["Todo", "Doing", "Done"] as const).map((col, ci) => (
        <div key={col} className="min-h-[160px] rounded-[18px] border border-[var(--k-hairline)] bg-[var(--k-surface-soft)] p-2.5">
          <h4 className="mb-3 text-[10px] font-semibold uppercase tracking-[0.07em] text-[var(--k-faint)]">{col}</h4>
...
export function HeroVisuals() {
  return (
    <div className="relative grid grid-cols-1 gap-6 lg:grid-cols-12 items-start w-full max-w-[1240px] px-6">
      ...
      <div className="k-card-fade lg:col-span-3 lg:mt-12 rounded-3xl border border-[var(--k-hairline)] bg-[var(--k-card)] p-6 text-left shadow-[0_20px_50px_-15px_rgba(0,0,0,0.8)] min-h-[330px] flex flex-col justify-between overflow-hidden k-interactive-card">
        <div>
          <div className="flex items-center gap-2.5 mb-5">
            <CheckCircle size={18} weight="fill" className="text-[var(--k-accent)]" />
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="rounded-[14px] border border-[var(--k-hairline)] bg-[var(--k-surface-soft)] p-3.5 flex flex-col gap-2.5">
              <div className="flex items-start justify-between gap-2">
                <span className="text-[12px] font-medium text-[var(--k-ink2)] leading-snug">Landing Page Redesign</span>
                <span className="h-2 w-2 rounded-full bg-amber-400 shrink-0 mt-1 shadow-[0_0_8px_rgba(251,191,36,0.6)]" />
              </div>
              <div className="flex gap-1.5">
                <span className="h-1.5 w-5 rounded-full bg-[var(--k-accent)]" />
                <span className="h-1.5 w-5 rounded-full bg-[var(--k-accent)]" />
            ...
            <div className="rounded-[14px] border border-transparent bg-transparent px-3.5 py-2 flex flex-col gap-2.5 opacity-50">
              <div className="flex items-start justify-between gap-2">
                <span className="text-[12px] font-medium text-[var(--k-faint)] line-through leading-snug">API Database Schema</span>
            ...
            <div className="rounded-[14px] border border-transparent bg-transparent px-3.5 py-2 flex flex-col gap-2.5">
              <div className="flex items-start justify-between gap-2">
                <span className="text-[12px] font-medium text-[var(--k-ink2)] leading-snug">Client Pitch Deck</span>
      ...
      <div className="k-card-fade lg:col-span-6 self-start -translate-y-[10px] rounded-3xl border border-[var(--k-hairline)] bg-[var(--k-card)] p-10 text-center shadow-[0_30px_70px_-20px_rgba(0,0,0,0.9)] min-h-[300px] flex flex-col justify-between relative overflow-hidden k-interactive-card">
        {/* Glow behind timer */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-56 h-56 bg-[var(--k-wash-10)] rounded-full blur-[50px] opacity-60 pointer-events-none" />
        
        <div className="flex flex-col items-center relative z-10">
          <span className="inline-flex items-center gap-2 rounded-full bg-[var(--k-surface-soft)] px-3.5 py-1.5 text-[11px] font-medium text-[var(--k-muted)] border border-[var(--k-hairline)]">
        ...
        <div className="flex justify-center gap-3 mb-2 relative z-10">
          ...
          <button className="h-11 w-11 rounded-full bg-[var(--k-surface-soft)] border border-[var(--k-hairline2)] flex items-center justify-center text-[var(--k-danger)] hover:bg-[var(--k-tint)] transition-colors shadow-lg">
      ...
      <div className="k-card-fade lg:col-span-3 lg:mt-12 rounded-3xl border border-[var(--k-hairline)] bg-[var(--k-card)] p-6 text-left shadow-[0_20px_50px_-15px_rgba(0,0,0,0.8)] min-h-[330px] flex flex-col justify-between overflow-hidden k-interactive-card">
        <div>
          <div className="flex items-center gap-2.5 mb-5">
            <ChartBar size={18} weight="fill" className="text-[var(--k-accent)]" />
          ...
          <div className="flex items-end gap-2.5 h-32 mt-6 px-1">
            ...
            <div className="flex-1 bg-gradient-to-t from-[var(--k-wash-20)] to-[var(--k-accent)] rounded-t-md h-[90%] relative shadow-[0_0_15px_rgba(0,102,255,0.3)]">
               <div className="absolute -top-6 left-1/2 -translate-x-1/2 text-[10px] font-bold text-[var(--k-accent)]">6h</div>
            </div>
  ...
  return (
    <div className="w-full max-w-[700px] rounded-3xl border border-[var(--k-line2)] bg-[var(--k-card)] p-8 text-left shadow-[0_30px_60px_-15px_rgba(0,0,0,0.85)] relative overflow-hidden k-glass-panel z-10">
        ...
        <div className="flex flex-col gap-4">
          <div>
            ...
            <input 
              ...
              className="h-10 w-full rounded-lg border border-[var(--k-line2)] bg-[var(--k-bg2)] px-3 text-[13px] text-[var(--k-ink)] outline-none"
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input 
                ...
                readOnly 
                value="flowmate" 
                className="h-10 w-full rounded-lg border border-[var(--k-line2)] bg-[var(--k-bg2)] px-3 pr-10 text-[13px] text-[var(--k-ink)] outline-none"
              />
      ...
      <div className="mt-6 flex flex-wrap gap-2.5 pt-5 border-t border-[var(--k-hairline)]">
        ...
        {/* Action Button */}
        <button className="ml-auto bg-[var(--k-ink)] text-[var(--k-bg)] rounded-full font-bold px-6 py-2 text-[13px] hover:opacity-90 transition active:scale-[0.98] shadow-md">
          Start Active Brew
        </button>
      </div>
